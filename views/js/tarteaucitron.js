...
var tarteaucitron = {
    ...
    "userInterface": {
        ...
        "color": function (key, status) {
            ...
            //     redLight = '#FFE2E2',
            //     yellowDark = '#FBDA26',
            var gray = tarteaucitron.parameters.btnDisabledColor,
                greenDark = tarteaucitron.parameters.btnAllowColor,
                redDark = tarteaucitron.parameters.btnDenyColor,
            ...
            if (nbDenied === 0 && nbPending === 0) {
                ...
                tarteaucitron.userInterface.css(c + 'AllDenied', 'backgroundColor', gray); // Visolo: "Added Line"
                tarteaucitron.userInterface.css(c + 'AllDenied', 'opacity', '0.4');
                tarteaucitron.userInterface.css(c + 'AllAllowed', 'opacity', '1');
            } else if (nbAllowed === 0 && nbPending === 0) {
                tarteaucitron.userInterface.css(c + 'AllAllowed', 'opacity', '0.4');
                tarteaucitron.userInterface.css(c + 'AllDenied', 'opacity', '1');
                tarteaucitron.userInterface.css(c + 'AllAllowed', 'backgroundColor', gray); // Visolo: "Added Line"
        ...
        "jsSizing": function (type) {
            ...
            if (type === 'box') {
                ...
                if (document.getElementById('tarteaucitron') !== null) {
                    ...
                    // apply "LA SIGUIENTE LINEA SE HA COMENTADO PORQUE ROMPE LA COLOCACIÓN DEL PANEL CUANDO ESTA DEFINIDO privacyUrl"
